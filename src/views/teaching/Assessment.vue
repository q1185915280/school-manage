  ...
  <div>
    ...
    <el-form :inline="true" :model="formInline" class="user-search">
      ...
      <el-form-item label="实验名称">
        <el-input size="small" v-model="formInline.userName" placeholder=""></el-input>
      </el-form-item>
      <el-form-item label="考核状态">
        <el-input size="small" v-model="formInline.userMobile" placeholder=""></el-input>
      </el-form-item>
    ...
    <el-table size="small" @selection-change="selectChange" :data="userData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column label="操作" min-width="100">
        <template slot-scope="scope">
          <el-button size="mini">评阅</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
